...
public sealed class XRaySigV4Handler : DelegatingHandler
{
    ...
    public XRaySigV4Handler(AWSCredentials credentials, string region)
    ...
    {
        var creds = await _credentials.GetCredentialsAsync().ConfigureAwait(false);
        ...
        // Re-set content since we already read the bytes
